...
extension MilitaryAction {
    ...
    static let allActions: [MilitaryAction] = [
        ...
        MilitaryAction(
            ...
            detailedDescription: "Organize and lead a study session on the Chairman's Doctrine or other Party doctrine. Essential political work for maintaining ideological purity in the ranks.",
            iconName: "book.fill",
            actionVerb: "Conduct",
        ...
        MilitaryAction(
            ...
            detailedDescription: "Launch a comprehensive ideological education campaign in your command. Campaigns focus on Party loyalty, the Chairman's Doctrine, or specific themes like anti-corruption. These demonstrate political reliability to superiors.",
        ...
        MilitaryAction(
            ...
            detailedDescription: "Initiate an investigation into suspected corruption - selling ranks, bribery, or misappropriation. Anti-corruption work is a priority of the current leadership. Success can remove rivals; failure may expose your own networks.",
        ...
        MilitaryAction(
            ...
            detailedDescription: "Launch a comprehensive anti-corruption campaign across your theater command. The leadership has made anti-corruption in the military a priority. This can remove entire networks of corrupt officers - including your rivals.",
        ...
        MilitaryAction(
            ...
            detailedDescription: "Initiate a nationwide purge of the PLA targeting corruption networks, disloyal officers, and factional enemies. This is the ultimate demonstration of power over the military.",
            iconName: "flame.fill",
            actionVerb: "Launch",
            category: .cmcAuthority,
            minimumPositionIndex: 7,
