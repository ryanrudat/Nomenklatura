...
final class PartyActionService {
    ...
    private func resolveAction(
        ...
        let chiefModifier = bureauChief(for: "partyApparatus", in: game)?.competenceSuccessModifier ?? 1.0
    ...
    private func executeNPCPartyAction(
        ...
        // Simple success check for NPC actions — chief competence scales the chance.
